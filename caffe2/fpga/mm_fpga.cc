...
)
{
  ...
  //TODO: need to be update to a new xclbin file, now commented out for testing
  ...
  //A and B here are arrays, change them to vectors
  ...
  // for (int i=0; i< M*N; ++i)
  // {
  //   //std::cout<<"inside the kernel"<<std::endl;
  //   ofmMat[i] = i;
  // }
  //testing timing
  // fpga_times[0] = 1.1;
...
//TIMER ENEABLED MACRO CAN BE TURNED ON/OFF IN fpga/mesh_processor.hpp 
  std::cout << "Timing starts" << std::endl;
  int teSize = 7;
